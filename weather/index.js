const apiKey = "5794c81ee92c629ab7b77967adcfb2cb"
...
async function getWeatherData(cityValue) {
    try {
        ...
        const details = [
            `Feels like: ${Math.round(data.main.feels_like) / 10}`,
        ...
        weatherDataEl.querySelector(".temperature").textContent = `${temperature / 10}°C`
